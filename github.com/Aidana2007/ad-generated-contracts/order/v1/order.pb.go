...
const file_order_v1_order_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt2f\n" +
	"\x12OrderStreamService\x12P\n" +
	"\x17SubscribeToOrderUpdates\x12\x16.order.v1.OrderRequest\x1a\x1b.order.v1.OrderStatusUpdate0\x01B?Z=github.com/Aidana2007/ad-generated-contracts/order/v1;orderv1b\x06proto3"
...
var file_order_v1_order_proto_depIdxs = []int32{
	2, // 0: order.v1.OrderStatusUpdate.created_at:type_name -> google.protobuf.Timestamp
	0, // 1: order.v1.OrderStreamService.SubscribeToOrderUpdates:input_type -> order.v1.OrderRequest
	1, // 2: order.v1.OrderStreamService.SubscribeToOrderUpdates:output_type -> order.v1.OrderStatusUpdate
